...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="img/slide-3.jpg" class="d-block w-100" height="450px" alt="...">
      </div>
      <div class="carousel-item">
        <img src="img/slide-4.jpg" class="d-block w-100" height="450px" alt="...">
      </div>
    </div>
  ...
  <div class="container my-4">
    ...
    <div class="row">
      ...
      <!-- Use a while to iterate the Categories  -->
